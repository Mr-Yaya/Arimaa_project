...
bad_position(X,Y,Piece) :- trap(X,Y),\+friendly_neighbor(X,Y,silver),!.

%dangerous position

bad_position(X,Y,Piece) :- \+friendly_neighbor(X,Y,silver), enemy_neighbor(X,Y,Enemy,gold), stronger(Enemy,Piece),!. 

%frozen Piece

frozen(X1,Y1,Piece) :- \+friendly_neighbor(X1,Y1,silver), enemy_neighbor(X1,Y1,Enemy,gold), stronger(Enemy,Piece), !.

%push & pull

ok_push_pull(X1,Y1,Piece) :- enemy_neighbor(X1,Y1,Enemy,gold), stronger(Piece,Enemy), !.
...
getAllMoves([X,Y],Moves,okMooves, Board):- 
											Board = [[0,0,rabbit,silver],[0,1,rabbit,silver],[0,2,horse,silver],[0,3,rabbit,silver],[0,4,elephant,silver],[0,5,rabbit,silver],[0,6,rabbit,silver],[0,7,rabbit,silver],[1,0,camel,silver],[1,1,cat,silver],[1,2,rabbit,silver],[1,3,dog,silver],[1,4,rabbit,silver],[1,5,horse,silver],[1,6,dog,silver],[1,7,cat,silver],[2,7,rabbit,gold],[6,0,cat,gold],[6,1,horse,gold],[6,2,camel,gold],[6,3,elephant,gold],[6,4,rabbit,gold],[6,5,dog,gold],[6,6,rabbit,gold],[7,0,rabbit,gold],[7,1,rabbit,gold],[7,2,rabbit,gold],[7,3,cat,gold],[7,4,dog,gold],[7,5,rabbit,gold],[7,6,horse,gold],[7,7,rabbit,gold]],
											setof(
												([X,Y]), 
